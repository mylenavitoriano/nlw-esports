            ...
            <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
              ...
              <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                <div className='flex flex-col gap-2'>
                    ...
                    <select id="game" name="game" className='bg-zinc-900 py-3 px-4 rounded text-sm' defaultValue={""}>
                ...
                <footer className='mt-4 flex justify-end gap-4'>
                  <Dialog.Close type="button" className='bg-zinc-500 px-5 h-12 rounded-md font-semibold hover:bg-zinc-600 ease-in-out duration-200'>
                    Cancelar
                  </Dialog.Close>
                  <button type='submit' className='bg-violet-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3 hover:bg-violet-600 ease-in-out duration-200'>
